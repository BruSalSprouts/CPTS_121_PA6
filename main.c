...
int main(void) {
    ...
    do {
        printf(" How would you like to place your pieces?\n 1) Manually with directions\n 2) Manually coordinate by coordinate\n 3) Let the game do it for me\n");
        scanf("%d", &placementChoice);
    } while (placementChoice != 1 && placementChoice != 2);
    switch (placementChoice) {
    case 1:
        fprintf(outfile, "Player 1's pieces\n");
        manual_placement_direction(player1Board, player1Ships); 
        break;
    case 2:
        fprintf(outfile, "Player 1's pieces\n");
        manual_placement_coordinates(player1Board, player1Ships);
        break;
    case 3:
        fprintf(outfile, "Player 1's pieces\n");
